...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="py-36 md:py-44 px-6 relative overflow-hidden"
    >
      <div 
      ...
      />
      <div className="relative max-w-[1200px] mx-auto z-10" ref={ref}>
        <motion.p
          initial={{ opacity: 0, y: 12 }}
          animate={inView ? { opacity: 1, y: 0 } : {}}
          transition={{ duration: 0.5 }}
          className="text-[13px] font-medium tracking-[0.08em] uppercase text-[color:var(--color-text-tertiary)] mb-14"
        >
          About
        </motion.p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 xl:gap-24">
          ...
          >
            <h2 className="font-serif text-[clamp(2rem,4vw,3rem)] leading-[1.08] tracking-[-0.02em] text-[color:var(--color-text-inverse)] mb-10">
              I&apos;ve worked inside the workflows you&apos;re trying to fix.
            </h2>
            <p className="text-[color:var(--color-text-tertiary)] text-base leading-[1.7] mb-6">
            ...
            <p className="text-[color:var(--color-text-tertiary)] text-[15px] leading-[1.7] mb-6">
            ...
            <p className="text-[color:var(--color-text-tertiary)] text-[15px] leading-[1.7]">
          ...
          >
            {[
              ...
              <motion.div
                ...
                className="flex items-start justify-between gap-4 p-5 rounded-xl border border-white/[0.06] bg-white/[0.02] hover:bg-white/[0.05] transition-colors duration-200"
              >
                <div>
                  <div className="font-medium text-[14px] text-[color:var(--color-text-inverse)] mb-1">
                    {item.label}
                  </div>
            ...
            <motion.blockquote
              ...
              className="mt-4 border-l-2 border-[color:var(--color-accent)]/40 pl-5"
            >
              <p className="text-[color:var(--color-text-tertiary)] text-[15px] leading-[1.8] font-serif italic">
